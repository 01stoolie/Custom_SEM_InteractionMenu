...
function StaffRestrict()
    if Config.StaffAccess == 0 then
        return false
    elseif Config.StaffAccess == 1 then
        return StaffAce
    else
        return true
    end
...
function DotRestrict()
    if Config.DotAccess == 0 then
        return false
    elseif Config.DotAccess == 1 then
        return true
    else
        return true
    end
